...
class 売上データ明細 extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['配送担当者ＣＤ', '商品ＣＤ', '商品区分', '現金個数', '現金金額', '現金値引', '現金値引事由ＣＤ', '掛売個数', '掛売金額', '掛売値引', '掛売値引事由ＣＤ', '請求日付', '予備金額１', '予備金額２', '売掛現金区分', '予備ＣＤ２', '主食ＣＤ', '副食ＣＤ', '分配元数量', '食事区分', '修正担当者ＣＤ', '修正日'];
