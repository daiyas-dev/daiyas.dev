 ...
 * @property string $修正日
 * @property string $対策の検証
 * @property int $対策の検証入力担当者コード
 * @property string $対策の検証入力担当者名
 */
class クレームデータ extends BaseModel
{
     ...
     * @var array
     */
    protected $fillable = ['受付日時', '管轄部門コード', 'クレーム区分コード', '顧客コード', '平均食数', '顧客担当者名', '商品コード', '単価', 'クレーム内容', '受付担当者コード', '受付方法', 'クレーム処理日', 'クレーム処理者コード', 'クレーム処理品', 'クレーム処理費用', '客先反応', '部門コード', '部門名', '原因部署担当コード', '原因', '原因入力担当者コード', '原因入力担当者名', '対策', '対策入力担当者コード', '対策入力担当者名', 'その後客先失客', '失客日', '失客日数', '未使用フラグ', '修正担当者ＣＤ', '修正日', '対策の検証', '対策の検証入力担当者コード', '対策の検証入力担当者名'];
