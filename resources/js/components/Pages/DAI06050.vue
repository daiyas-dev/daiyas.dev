    ...
    methods: {
        ...
        print: function() {
            ...
            var styleCustomers =`
                ...
                table.DAI06050Grid1 thead tr {
                    border-top: solid 1px black;
                }
                table.DAI06050Grid1 tbody tr[level="1"].group-row {
                    border-top: solid 1px black;
                }
                table.DAI06050Grid1 tbody tr td {
                    border-bottom: dotted 1px black;
                }
                table.DAI06050Grid1 tbody tr[level="1"].group-summary td {
                    border-bottom: dotted 0px black;
                }
                table.DAI06050Grid1 tbody tr.group-summary td {
                    border-bottom: dotted 0px black;
                }
                table.DAI06050Grid1 tbody tr.grand-summary td {
                    border-bottom: dotted 0px black;
                }
                table.DAI06050Grid1 tbody tr td:nth-child(1) {
                    border-bottom: dotted 0px black;
                }
                table.DAI06050Grid1 thead tr th:nth-child(1) {
                    width: 20%;
                }
                table.DAI06050Grid1 thead tr th:nth-child(2) {
                    width: 20%;
                }
            `;
