...
<style>
#DAI07070Grid1 svg.pq-grid-overlay {
    display: block;
}
#DAI07070Grid1 .pq-grid-cell.holiday {
    color: red;
}
#DAI07070Grid1 .pq-summary-outer *:not(.tooltip):not(.arrow):not(.tooltip-inner) {
    font-weight: bold;
    color: black;
    ...
    watch: {
        searchParams: {
            ...
            handler: function(newVal) {
                ...
                vue.footerButtons.find(v => v.id == "DAI07070Grid1_Search").disabled = disabled;
            },
        },
    },
    data() {
    ...
    methods: {
        createdFunc: function(vue) {
            vue.footerButtons.push(
                { visible: "true", value: "検索", id: "DAI07070Grid1_Search", disabled: false, shortcut: "F1",
                    onClick: function () {
                        vue.DAI07070Grid1.searchData(vue.searchParams);
                    }
                },
                { visible: "false" } ,
                { visible: "true", value: "実行", id: "DAI07070Grid1_ExecuteAll", disabled: false, shortcut: "F5",
                    onClick: function () {
                        var grid = vue.DAI07070Grid1;
                        ...
                        grid.saveData(
                            {
                                uri: "/DAI07070/Save",
                                params: {
                                    CustomerList: DAI07070Grid1.pdata.map(v => v.得意先ＣＤ),
                                },
                ...
                { visible: "true", value: "個別実行", id: "DAI07070Grid1_ExecuteSingle", disabled: false, shortcut: "F6",
                    onClick: function () {
                        var grid = vue.DAI07070Grid1;
                ...
                { visible: "true", value: "個別解除", id: "DAI07070Grid1_ReleaseSingle", disabled: false, shortcut: "F7",
                    onClick: function () {
                        var grid = vue.DAI07070Grid1;
                        var selection = grid.SelectRow().getSelection();
                        var rows = grid.SelectRow().getSelection();
                ...
                { visible: "false" } ,
                { visible: "true", value: "CSV", id: "DAI07070Grid1_CSV", disabled: true, shortcut: "F10",
                    onClick: function () {
                        vue.DAI07070Grid1.vue.exportData("csv", false, true);
                    }
                },
                { visible: "true", value: "Excel", id: "DAI07070Grid1_Excel", disabled: true, shortcut: "F9",
                    onClick: function () {
                        vue.DAI07070Grid1.vue.exportData("xlsx", false, true);
                    }
                },
                { visible: "true", value: "印刷", id: "DAI07070Grid1_Print", disabled: true, shortcut: "F11",
                    onClick: function () {
                        vue.print();
                    }
                },
        ...
        showLastSimeDate: function(){
            ...
            axios.post("/DAI07070/LastSimeDateSearch", { BushoCd:vue.viewModel.BushoCd, SimeKbn:vue.viewModel.SimeKbn, timestamp:tc})
                .then(response => {
        ...
        onAfterSearchFunc: function (grieVue, grid, res) {
            ...
            vue.footerButtons.find(v => v.id == "DAI07070Grid1_CSV").disabled = !res.length;
            vue.footerButtons.find(v => v.id == "DAI07070Grid1_Excel").disabled = !res.length;
            vue.footerButtons.find(v => v.id == "DAI07070Grid1_Print").disabled = !res.length;
                        ...
                        .append(
                            grid.generateHtml(
                                `
                                    ...
                                    table.DAI07070Grid1 tr:nth-child(1) th {
                                        border-style: solid;
                                        border-left-width: 1px;
                                        border-top-width: 1px;
                                        border-right-width: 0px;
                                    ...
                                    table.DAI07070Grid1 tr th:last-child {
                                        border-right-width: 1px;
                                    }
                                    table.DAI07070Grid1 tr td {
                                        border-style: solid;
                                        border-left-width: 1px;
                                        border-top-width: 0px;
                                        border-right-width: 0px;
                                    ...
                                    table.DAI07070Grid1 tr.grand-summary td {
                                        border-style: solid;
                                        border-left-width: 1px;
                                        border-top-width: 0px;
                                        border-right-width: 0px;
                                    ...
                                    table.DAI07070Grid1 tr td:last-child {
                                        border-right-width: 1px;
                                    }
                                `,
                                headerFunc,
