    ...
    methods: {
        createdFunc: function(vue) {
            vue.footerButtons.push(
                ...
                {visible: "false"},
                {visible: "false"},
                { visible: "true", value: "CSV", id: "DAI05030Grid1_CSV", disabled: true, shortcut: "F10",
                    onClick: function () {
                        vue.DAI05030Grid1.vue.exportData("csv", false, true);
                    }
                },
                { visible: "true", value: "印刷", id: "DAI05030Grid1_Print", disabled: true, shortcut: "F11",
                    onClick: function () {
                        vue.print();
                    }
                },
        ...
        filterChanged: function() {
            ...
            //ボタン無効化制御
            //vue.footerButtons.find(v => v.id == "DAI05030Grid1_CSV").disabled = (grid.pdata.length==0);
            //vue.footerButtons.find(v => v.id == "DAI05030Grid1_Print").disabled = (grid.pdata.length==0);
            return;
        },
        onAfterSearchFunc: function (vue, grid, res) {
            ...
            //ボタン無効化制御
            //vue.footerButtons.find(v => v.id == "DAI05030Grid1_CSV").disabled = !res.length;
            //vue.footerButtons.find(v => v.id == "DAI05030Grid1_Print").disabled = !res.length;
        ...
        print: function() {
            ...
            var styleCustomers =`
                table.DAI05030Grid1
                table.DAI05030Grid1 tr,
                table.DAI05030Grid1 th,
                table.DAI05030Grid1 td {
            ...
            var printable = $("<html>")
                ...
                .append(
                    $("<body>")
                        .append(
                            vue.DAI05030Grid1.generateHtml(
                                styleCustomers,
                                headerFunc,
                                16,
